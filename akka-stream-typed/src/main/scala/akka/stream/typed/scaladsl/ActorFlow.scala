...
object ActorFlow {
  ...
  def ask[I, Q, A](
      ref: ActorRef[Q]
  )(makeMessage: (I, ActorRef[A]) => Q)(implicit timeout: Timeout): Flow[I, A, NotUsed] =
  ...
  def ask[I, Q, A](
      parallelism: Int
  )(ref: ActorRef[Q])(makeMessage: (I, ActorRef[A]) => Q)(implicit timeout: Timeout): Flow[I, A, NotUsed] = {
