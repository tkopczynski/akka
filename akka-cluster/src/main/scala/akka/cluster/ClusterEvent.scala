...
object ClusterEvent {
  ...
  object CurrentClusterState
      extends AbstractFunction5[immutable.SortedSet[Member], Set[Member], Set[Address], Option[Address], Map[
        String,
        Option[Address]
      ], CurrentClusterState] {
    ...
    def unapply(
        cs: CurrentClusterState
    ): Option[(immutable.SortedSet[Member], Set[Member], Set[Address], Option[Address], Map[String, Option[Address]])] =
  ...
  final class CurrentClusterState(val members: immutable.SortedSet[Member],
      ...
      extends Product5[immutable.SortedSet[Member], Set[Member], Set[Address], Option[Address], Map[String, Option[
        Address
      ]]]
      with Serializable {
   ...
   * Internal API
   */
  private[cluster] def isReachable(state: MembershipState,
                                   oldUnreachableNodes: Set[UniqueAddress])(otherDc: DataCenter): Boolean = {
