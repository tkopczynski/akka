...
object ActorMaterializer {
  ...
  def apply(materializerSettings: Option[ActorMaterializerSettings] = None,
            namePrefix: Option[String] = None)(implicit context: ActorRefFactory): ActorMaterializer = {
  ...
  def apply(materializerSettings: ActorMaterializerSettings,
            namePrefix: String)(implicit context: ActorRefFactory): ActorMaterializer = {
...
final class IOSettings private (val tcpWriteBufferSize: Int) {
  ...
  private def copy(tcpWriteBufferSize: Int = tcpWriteBufferSize): IOSettings =
    new IOSettings(tcpWriteBufferSize = tcpWriteBufferSize)
