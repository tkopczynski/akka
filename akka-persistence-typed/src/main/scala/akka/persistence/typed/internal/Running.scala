...
/** INTERNAL API */
@InternalApi private[akka] class Running[C, E, S](override val setup: BehaviorSetup[C, E, S])
  ...
  private def onSnapshotterResponse(response: SnapshotProtocol.Response,
